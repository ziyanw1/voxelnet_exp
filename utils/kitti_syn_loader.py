...
class Processor:
    def __init__(self, data_tag, f_rgb, f_lidar, f_obj, f_label, data_dir, aug, is_testset):
...
def iterate_data(data_dir, shuffle=False, aug=False, is_testset=False, batch_size=1, multi_gpu_sum=1):
    ...
    proc=Processor(data_tag, f_rgb, f_lidar, f_obj, f_label, data_dir, aug, is_testset)
